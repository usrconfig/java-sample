...
public enum GameErrorCode implements IErrorCode {
    ...
    HERO_NOT_FOUND("Hero_not_found %d", 23),
    HERO_MAX_LEVEL_REQUIRE("HERO_MAX_LEVEL_REQUIRE %d", 24),
    HERO_SAME_RANK_REQUIRE("HERO_SAME_RANK_REQUIRE ", 25),

    //Campaign
    MATCH_NOT_FOUND("MATCH_NOT_FOUND", 26),

    //Item
    ITEM_RANK_REQUIRE("ITEM_RANK_REQUIRE", 40),
    ITEM_NOT_FOUND("ITEM_NOT_FOUND", 41),
    ITEM_BEING_EQUIPPED("ITEM_BEING_EQQUIPPED", 42),

    CHECK_OFFCHAIN_ASSET("CHECK_OFFCHAIN_ASSET", 50),
