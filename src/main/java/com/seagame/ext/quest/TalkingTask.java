 ...
 * @author LamHM
 */
public class TalkingTask extends QuestObserver {
    public TalkingTask(QuestSystem questSystem) {
        super(questSystem);
    }
    ...
    public void update(QuestData questData) {
        ...
        QAntTracer.debug(this.getClass(), "[DEBUG] process TalkingTask");
    ...
    public static QuestData init(QAntUser user, String task) {
        ...
        return new QuestData(data, user, TYPE_TALK);
    }
